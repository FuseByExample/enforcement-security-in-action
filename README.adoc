...
curl http://downloads.jboss.org/apiman/1.2.2.Final/apiman-distro-wildfly10-1.2.2.Final-overlay.zip -o apiman-distro-wildfly10-1.2.2.Final-overlay.zip
unzip wildfly-10.0.0.Final.zip
unzip -o apiman-distro-wildfly10-1.2.2.Final-overlay.zip -d wildfly-10.0.0.Final
